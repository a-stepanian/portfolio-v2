...
const Wrapper = styled.div`
  ...
  .three-d-object {
    ...
    .side1 {
      transform: rotateY(0deg) translateZ(calc(calc((100vw - 250px) / 2) / 2 / 0.5774));
    }
    .side2 {
      transform: rotateY(60deg) translateZ(calc(calc((100vw - 250px) / 2) / 2 / 0.5774));
    }
    .side3 {
      transform: rotateY(120deg) translateZ(calc(calc((100vw - 250px) / 2) / 2 / 0.5774));
    }
    .side4 {
      transform: rotateY(180deg) translateZ(calc(calc((100vw - 250px) / 2) / 2 / 0.5774));
    }
    .side5 {
      transform: rotateY(240deg) translateZ(calc(calc((100vw - 250px) / 2) / 2 / 0.5774));
    }
    .side6 {
      transform: rotateY(300deg) translateZ(calc(calc((100vw - 250px) / 2) / 2 / 0.5774));
    }
  }
  ...
  .icon-shadow {
    ...
    filter: blur(13px);
    transform: scale(1.2);
    animation: shadow-spin-and-pulse 6s ease-in-out infinite 0.1s;
  }
  /* Animations */
  @keyframes appear {
    0% {
  ...
  @keyframes shadow-spin-and-pulse {
    ...
    50%,
    100% {
      transform: scale(1.2) rotateZ(0) translateY(-2px);
      filter: blur(13px);
    }
    25% {
      transform: scale(1) rotateZ(-5deg) translateY(0px) rotateY(10deg);
      filter: blur(6px);
    }
    75% {
      transform: scale(1) rotateZ(5deg) translateY(0px) rotateY(-10deg);
  ...
  @keyframes infinite-spin {
    0% {
      transform: translateZ(calc(calc((100vw - 250px) / 2) / 2 / -0.5774)) rotateY(0deg);
    }
    100% {
      transform: translateZ(calc(calc((100vw - 250px) / 2) / 2 / -0.5774)) rotateY(360deg);
    }
  }
`;
